...
const TABS = [
  {
    name: "listings",
    href: "/host/listings" as any,
    label: "Listings",
    icon: "storefront",
  },
  {
    name: "booking",
    href: "/host/booking" as any,
    label: "Booking",
    icon: "calendar",
  },
  {
  ...
  {
    name: "inbox",
    href: "/host/inbox" as any,
    label: "Inbox",
    icon: "chat_bubble",
  },
  {
    name: "profile",
    href: "/host/profile" as any,
    label: "Profile",
    icon: "account_circle",
  },
] as const;
...
function NavButton({ isFocused, icon, label, ...props }: NavButtonProps) {
  ...
  return (
    ...
    >
      <SymbolView name={icon as any} tintColor={iconColor} size={22} />
      <ThemedText
        style={[
          styles.navLabel,
